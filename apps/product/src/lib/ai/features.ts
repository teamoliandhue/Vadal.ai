...
export const FEATURES: FeatureStatus[] = [
  ...
  { id: "pulse-sendtime", pillar: "Pulse", brief: "Smart send-time and channel selection per person", module: "engines/timing", entry: "planSend", agentic: false, surface: "engine-only", wiredTo: null },
