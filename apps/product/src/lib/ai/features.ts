...
export type FeatureStatus = {
  ...
  blocked?: string;
  /**
   * The call site that makes this reachable, or null when nothing calls it yet.
   *
   * Generated by scripts/ai-reachability.mjs — never edited by hand, because
   * that is exactly how it drifted. verifyFeatures() originally only proved the
   * implementation EXISTED, which is not the same as a person being able to get
   * to it: thirteen features were exported, tested and invisible while the
   * registry reported them as reachable.
   */
  wiredTo?: string | null;
};
...
export const FEATURES: FeatureStatus[] = [
  ...
  { id: "pulse-adaptive", pillar: "Pulse", brief: "Adaptive survey length — the next question is chosen based on prior answers", module: "engines/survey", entry: "nextQuestion", agentic: false, surface: "engine-only", wiredTo: "app/product/survey/[id]/Respond.tsx" },
  ...
  { id: "pulse-sendtime", pillar: "Pulse", brief: "Smart send-time and channel selection per person", module: "engines/timing", entry: "planSend", agentic: false, surface: "engine-only", wiredTo: "app/product/pulse/Programmes.tsx" },
  { id: "pulse-launch", pillar: "Pulse", brief: "AGENTIC — launch a quick pulse to a segment on request", module: "tools", entry: "launch_pulse_survey", agentic: true, surface: "copilot", wiredTo: "lib/ai/mock.ts" },
  { id: "pulse-diagnose", pillar: "Pulse", brief: "AGENTIC — proactively launch a targeted micro-survey when an anomaly is flagged", module: "tools", entry: "diagnose_anomaly", agentic: true, surface: "copilot", wiredTo: "lib/ai/mock.ts" },
  ...
  /* ── Pillar 4 · Thrive ───────────────────────────────────── */
  { id: "thrive-nudge", pillar: "Thrive", brief: "Personalised nudges timed to when the person is likely to act", module: "engines/wellbeing", entry: "activityNudges", agentic: false, surface: "screen", wiredTo: "app/product/ithrive/ThriveHub.tsx" },
  { id: "thrive-money", pillar: "Thrive", brief: "AI financial tips by income band, role and region — guidance only", module: "engines/wellbeing", entry: "financialTips", agentic: false, surface: "screen", wiredTo: "app/product/ithrive/ThriveHub.tsx" },
  { id: "thrive-wellbeing", pillar: "Thrive", brief: "Anomaly-aware wellbeing check, with consent, offering a warm handoff", module: "engines/wellbeing", entry: "wellbeingCheck", agentic: false, surface: "screen", wiredTo: "app/product/ithrive/ThriveHub.tsx" },
  { id: "thrive-cohorts", pillar: "Thrive", brief: "Smart challenge matching into fair leaderboard cohorts", module: "engines/wellbeing", entry: "buildCohorts", agentic: false, surface: "screen", wiredTo: "app/product/ithrive/ThriveHub.tsx" },
  { id: "thrive-log", pillar: "Thrive", brief: "AGENTIC — log activity conversationally ('I ran 5k this morning')", module: "tools", entry: "log_activity", agentic: true, surface: "copilot", wiredTo: "lib/ai/mock.ts" },
  { id: "thrive-goal", pillar: "Thrive", brief: "AGENTIC — renegotiate a goal on request and adjust it", module: "tools", entry: "adjust_goal", agentic: true, surface: "copilot", wiredTo: "lib/ai/mock.ts" },
  ...
  /* ── Pillar 6 · Grow ─────────────────────────────────────── */
  { id: "grow-generate", pillar: "Grow", brief: "Course generation from a PDF/SOP/deck with quiz questions drafted for review", module: "engines/learning", entry: "generateCourse", agentic: false, surface: "screen", wiredTo: "app/product/ilearn/GrowHub.tsx" },
  { id: "grow-paths", pillar: "Grow", brief: "Personalised path recommendations from role, Pulse feedback and incident data", module: "engines/learning", entry: "recommendPaths", agentic: false, surface: "screen", wiredTo: "app/product/ilearn/GrowHub.tsx" },
  ...
  { id: "grow-timefit", pillar: "Grow", brief: "Match learning to the time actually available, at lesson granularity", module: "engines/learning", entry: "whatFitsIn", agentic: false, surface: "screen", wiredTo: "app/product/ilearn/Rail.tsx" },
  { id: "grow-tutor", pillar: "Grow", brief: "AI tutor answering only from that module's source content", module: "engines/learning", entry: "tutor", agentic: false, surface: "screen", wiredTo: "app/product/ilearn/GrowHub.tsx" },
  ...
  { id: "help-intake", pillar: "One-to-One Help", brief: "Empathetic conversational intake in plain, warm language", module: "engines/support", entry: "intake", agentic: false, surface: "screen", wiredTo: "app/product/icare/Companion.tsx" },
  ...
  { id: "help-handoff", pillar: "One-to-One Help", brief: "Consent-based handoff summary, with explicit sign-off", module: "engines/support", entry: "buildHandoff", agentic: false, surface: "screen", wiredTo: "app/product/icare/HelpHub.tsx" },
  { id: "help-resources", pillar: "One-to-One Help", brief: "Self-serve resource matching for lower-stakes moments", module: "engines/support", entry: "matchResources", agentic: false, surface: "screen", wiredTo: "app/product/icare/Companion.tsx" },
  ...
  { id: "help-concern", pillar: "One-to-One Help", brief: "Separate intake for someone worried about a COLLEAGUE — triage reads its input as first-person, so a third-party report was mis-banded", module: "engines/support", entry: "concernIntake", agentic: false, surface: "screen", wiredTo: "app/product/icare/Companion.tsx" },
