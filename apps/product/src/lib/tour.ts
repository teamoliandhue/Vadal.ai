...
export const TOUR: TourStep[] = [
  ...
  },
  {
    ...
    pillar: { n: 7, name: "Support", tag: "AI Companion" , shortName: "Support", short: "Private support" },
    parts: [{ label: "Support", href: "/product/support" }],
    section: "Support", href: "/product/support",
    completesOn: "open:Support", actionLabel: "open Support", doneLabel: "opened Support",
  },
  {
    id: "managers",
