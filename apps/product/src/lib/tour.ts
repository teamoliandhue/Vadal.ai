...
export const TOUR: TourStep[] = [
  ...
  },
  {
    ...
    parts: [
      ...
      { label: "Pulse", href: "/product/surveys" },
  ...
  },
  {
    ...
    parts: [
      { label: "Social", href: "/product/feed" },
      { label: "Kudos", href: "/product/recognition" },
    ],
    section: "Social", href: "/product/feed",
  ...
  },
  {
    ...
    parts: [{ label: "iThrive", href: "/product/thrive" }],
    section: "iThrive", href: "/product/thrive",
  ...
  },
  {
    ...
    parts: [{ label: "iLearn", href: "/product/grow" }],
    section: "iLearn", href: "/product/grow",
  ...
  },
  {
    ...
    pillar: { n: 7, name: "SmartWork", tag: "AI Companion" , shortName: "SmartWork", short: "Private support" },
    parts: [{ label: "SmartWork", href: "/product/help" }],
    section: "SmartWork", href: "/product/help",
    completesOn: "open:SmartWork", actionLabel: "open SmartWork", doneLabel: "opened SmartWork",
  },
  {
    id: "managers",
  ...
  },
  {
    ...
    parts: [{ label: "Flow", href: "/product/cases" }],
    section: "Flow", href: "/product/cases",
