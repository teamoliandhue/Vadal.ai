...
export const feedItems: FeedItem[] = [
  {
    ...
    media: { src: "/feed/wellbeing.jpg", alt: "Colleagues taking a proper break together over chai" },
  ...
  },
  {
    ...
    media: { src: "/feed/ship.jpg", alt: "Two engineers at a monitor as the new search goes live" },
    reactions: { "🔥": 64, "🎉": 18, "👏": 11 },
  ...
  },
  {
    ...
    media: { src: "/feed/milestone.jpg", alt: "The team clapping for Arjun at his desk" },
  ...
  },
  {
    id: "f6b",
    type: "post",
    author: { name: "Sunita Rao", role: "Shift Supervisor · Night shift", img: AV(7) },
    channel: "wins",
    time: "1d",
    text: "**200 days on Line 2 with no lost-time incident.** That is not luck — it is the pre-start checks, every shift, by everyone. Proud of this crew. 🦺",
    media: { src: "/feed/plant.jpg", alt: "Line 2 crew at shift handover on the plant floor" },
    reactions: { "👏": 214, "🔥": 63, "❤️": 38 },
    reactedBy: [AV(4), AV(6), AV(2)],
    views: 4120,
    comments: [
      c("f6b1", { name: "Karan Joshi", role: "Plant Ops", img: AV(4) }, "Whole shift earned this one 💪", "20h", 31),
      c("f6b2", { name: "Pradeep K.", role: "CEO", img: AV(6) }, "This is the number I'm proudest of all quarter. Thank you.", "18h", 74),
    ],
  },
  {
    id: "f7",
  ...
  },
  {
    ...
    media: { src: "/feed/coldbrew.jpg", alt: "Cold brew pouring into a glass at the pantry counter" },
    reactions: { "🔥": 41, "🎉": 12 },
    reactedBy: [AV(5), AV(8)],
    views: 640,
    comments: [
