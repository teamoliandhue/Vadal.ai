...
/* A fragment of each product, live — the thing you would see inside it, at
   stamp size. Monochrome and violet, with colour only where it means something
   (a falling report is red, reach is green). The grid stops being a menu. */
        ...
        {tiles.map((t, i) => (
          <li key={t.n} className="min-w-0">
            ...
            >
              ...
              <span className="relative hidden shrink-0 sm:block"><Mini name={t.name} /></span>
            </button>
          </li>
        ))}
      </ul>
